...
/**
 * Story graph + player-facing copy from the vetted Escape from Pinsk draft
 * (spreadsheet / scene bible). Do not soft-edit prose without source approval.
 */
...
export const NODES: Record<string, StoryNode> = {
  ...
  W05: {
    ...
    choices: [
      ...
      {
        id: "bribe",
        label: "Attempt to bribe the guards with the rest of your possessions and stay in the town",
        next: "W05B",
  ...
  W07: {
    ...
    choices: [
      {
        id: "flee",
        label: "Try to flee the train car with the escapees through a rain of gunfire",
        next: "W07A",
